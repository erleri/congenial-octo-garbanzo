...
- [ ] Mocked OpenRouter success, timeout, 429, invalid schema, unknown evidence, and forbidden numeric text are tested.
...
| Base date | Deterministic generated | AI selected | Validation | Decision | Critical issue |
| --- | --- | --- | --- | --- | --- |
